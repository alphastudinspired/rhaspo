...
var VoiceProfileClient = /** @class */ (function () {
     ...
     * @param err - Callback invoked in case of an error.
     */
    VoiceProfileClient.prototype.getActivationPhrasesAsync = function (profileType, lang, cb, err) {
        var _this = this;
        Exports_2.marshalPromiseToCallbacks((function () { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, new Exports_3.VoiceProfilePhraseResult(result.ok ? Exports_3.ResultReason.EnrollingVoiceProfile : Exports_3.ResultReason.Canceled, result.statusText, result.json())];
                }
            });
        }); })(), cb, err);
    };
